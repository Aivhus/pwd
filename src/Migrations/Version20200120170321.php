 ...
 */
final class Version20200120170321 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO category (title) VALUES ("entrée")');
        $this->addSql('INSERT INTO category (title) VALUES ("plat")');
        $this->addSql('INSERT INTO category (title) VALUES ("dessert")');
        $this->addSql('ALTER TABLE recette ADD category_id INT NOT NULL DEFAULT 1');
